...
function createSavedCard(destination,id) {
    ...
    return `
        ...
        <!-- IMAGE -->
            ...
            <div class=" relative h-52 overflow-hidden">
                ...
                <div class=" absolute top-3 left-3 bg-emerald-50 text-black-600 px-3 py-1.5 rounded-full text-xs font-bold shadow-sm ">
                    🔖 Saved
                </div>
            ...
            <div class="flex">
                ...
                <div class="mb-3">
                    ...
                    <span class="inline-flex items-center w-fit bg-gray-100 text-gray-600 px-3 py-1 mt-1 m-2 rounded-full text-xs font-semibold">
                ...
                <p class="text-sm text-emerald-700 font-semibold mb-3">
                ...
                <p class="text-sm text-gray-600 leading-relaxed line-clamp-3 mb-5">
                ...
                <div class="mt-auto flex gap-2">
                    ...
                    <button type="button" onclick="window.location.href ='explore-destination.html?id=${encodeURIComponent(id)}'"
                        class="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2.5 rounded-xl font-semibold text-sm transition">
                        Explore
                    </button>

                    <!-- REMOVE -->

                    <button type="button" onclick="removeSavedDestination('${String(id).replace(/'/g, "\\'")}')"
                        class="px-4 py-2.5 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-600 font-semibold text-sm transition">
                        Remove
                    </button>
...
function renderSavedDestinations() {
    ...
    savedDestinations.forEach(
        function (id) {
            ...
            if (!destination) {
                console.warn("Saved destination not found:",id);

                return;
            }

            savedGrid.innerHTML +=
                createSavedCard(destination,id);
...
window.removeSavedDestination =
    function (id) {
        ...
        savedDestinations =
            savedDestinations.filter(function (item) {
